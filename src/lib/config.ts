...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://test-project.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/test-project',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'test-project_progress' },
